...
router.patch('/:id/stage', requireRole(['Admin', 'Manager']), requestController.updateRequestStage);
...
router.delete('/:id', requireRole(['Admin', 'Manager']), requestController.deleteRequest);
