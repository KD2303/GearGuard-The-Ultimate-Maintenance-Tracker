...
First off, thank you for considering contributing to **GearGuard-The-Ultimate-Maintenance-Tracker!** We're excited to have you join our community. Every contribution, no matter how small, helps us build the best academic resource platform for students.
...
*Your contributions earn points that count toward NSoC'26 and your GearGuard-The-Ultimate-Maintenance-Tracker Leaderboard status!*
...
* ⌛ Reviews may take **24–72 hours** depending on activity. Thanks for your patience!
 ...
 > For Any Query, Send DM on LinkedIn [Krish Dargar](https://www.linkedin.com/in/krish-dargar-101774324/).
...
- Take a look at the existing [Issues](https://github.com/KD2303/GearGuard-The-Ultimate-Maintenance-Tracker/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/KD2303/GearGuard-The-Ultimate-Maintenance-Tracker/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
