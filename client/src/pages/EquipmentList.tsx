...
const EquipmentList: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    const exportData = equipment.map((item) => ({
      ...
      Status: item.status,
      'Maintenance Team': item.maintenanceTeam?.name || '',
    ...
    link.href = url;
    link.setAttribute('download', 'equipment-records.csv');
