...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:py-12 sm:px-6 lg:px-8 transition-colors">
      <div className="max-w-md w-full mx-auto space-y-6 sm:space-y-8 bg-white dark:bg-gray-800 p-6 sm:p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 transition-colors">
        <div>
          <div className="flex justify-center">
            <div className="bg-primary-100 dark:bg-primary-900/40 p-2 sm:p-3 rounded-xl transition-colors">
              <Shield className="h-8 w-8 sm:h-10 sm:w-10 text-primary-600 dark:text-primary-400" />
            </div>
          </div>
        ...
        <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={handleLogin}>
          <div className="rounded-md shadow-sm space-y-3 sm:space-y-4">
            <div>
              <label htmlFor="email-address" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Email address
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  required
                  className="appearance-none relative block w-full px-3 py-2.5 sm:py-3 pl-9 sm:pl-10 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 text-xs sm:text-sm bg-gray-50 dark:bg-gray-700 transition-all"
          ...
          {error && (
            <div className="bg-red-50 dark:bg-red-900/20 p-3 sm:p-4 rounded-lg flex items-start space-x-2 sm:space-x-3 border border-red-200 dark:border-red-800/50 animate-shake">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-3 sm:p-4 rounded-lg flex items-start space-x-2 sm:space-x-3 border border-blue-100 dark:border-blue-800/50">
            <AlertCircle className="h-4 w-4 sm:h-5 sm:w-5 text-blue-500 dark:text-blue-400 mt-0.5 flex-shrink-0" />
          ...
          <div>
            <Button
              type="submit"
              disabled={loading}
              className="py-2.5 sm:py-3 text-sm sm:text-base w-full"
            >
